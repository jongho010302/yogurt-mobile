...
const BookingDetails: React.FC<navigationProps> = ({ navigation }) => {
  ...
  const cancelAlert = () => {
    Alert.alert('예약 취소', '2020. 4. 20. (월) 11:00\n 기구 필라테스 수업을 취소하시겠습니까?',
      [
        { text: 'Cancel', onPress: () => console.log('nothing'), style: 'cancel' },
    ...
    <View style={{ flex: 1, backgroundColor: colors.lightSkyBlue }}>
      <View >
        <Card style={styles.card} >
          ...
          <Text note style={{ paddingLeft: '5%' }}>사용 상품</Text>
          <Card style={styles.card_ticket} >
            ...
            <View style={{ flexDirection: 'column' }}>
              <View style={{ backgroundColor:colors.lightSkyBlue, height: '90%', width: '38%', marginLeft: '40%', borderRadius: 5, padding: '5%' }} />
            </View>
          </Card>
          <View style={{ flexDirection: 'row', padding: '1%', justifyContent: 'flex-end' }}>
            <View style={{ flexDirection: 'column', padding: '1%', justifyContent: 'flex-end' }}>
              <Text note style={{ marginRight: '10%' }}>잔여횟수</Text>
              <Text note style={{ marginRight: '10%' }}>잔여일</Text>
            </View>
            <View style={{ flexDirection: 'column', padding: '1%', justifyContent: 'flex-end' }}>
          ...
          <View style={{ flexDirection: 'row', padding: '5%', justifyContent: 'flex-start' }}>
            <Text note style={{ fontSize: 10 }}>예약일시: </Text>
            <Text note style={{ fontSize: 10 }}>2020. 4. 13 12:01:36</Text>
          </View>
        </Card>
