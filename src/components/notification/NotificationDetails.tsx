...
const NotificationDetails:React.FC<navigationProps> = ({ navigation }) => {
  ...
  return (
    <View>
      <Card style={{ borderRadius: 5, margin: '10%', padding: '5%', height: '90%'}}>
        <View style={{ flexDirection: 'column', justifyContent: 'space-between' }}>
          ...
          <BaseText text={item.lecturer + '강사의 ' + item.lectureName + '수업에 예약했습니다.'} customStyle={{ fontSize: 15, fontWeight: 'normal' }} />
        </View>
      </Card>
    </View>
  );
