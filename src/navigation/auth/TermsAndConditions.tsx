    ...
    <View style={{ flex: 1, backgroundColor: colors.white }}>
      <View style={{ flex: 1 }}>
        <View style={{ flex: 0.45 }}>
          <CheckBox title="Yogurt Studio 이용약관 동의" checked={isFirstCheckBox} onIconPress={() => SetFirstCheckBox()} />
        ...
        <View style={{ flex: 0.45 }}>
          <CheckBox title="Yogurt Studio 개인정보 수집 및 이용 동의" checked={isSecondCheckBox} onIconPress={() => SetSecondCheckBox()} />
          <Card style={{ borderColor: colors.white }}>
            <Text>Yogurt-Studio 이용약관</Text>
            <Text/>
            <Text/>
        ...
        <View style={{ flexDirection: 'row', alignItems: 'stretch', justifyContent: 'space-evenly' }}>
          ...
          <View style={{ backgroundColor: colors.lightSkyBlue, borderRadius: 10, alignItems: 'center', padding: '4%', paddingLeft: '15%', paddingRight: '15%' }}>
            <BaseButton
